<template>
  <div>
    <apexchart v-if="series" :width="configOption.width" :height="configOption.height" type="bar" :options="options"
...
const getCountEmployees = async () => {
  ...
  if (props.organization.length != 0) {
    API = 'dynamics/getAvargeAgeEmployeesCategoryNewOrganization'
    ...
    API = 'dynamics/getAvargeAgeEmployeesCategoryNew'
