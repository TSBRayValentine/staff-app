    ...
    <b-dropdown v-model="selectedOptions" @input="updateSelectedData" multiple aria-role="list" style="dropdown">
      <template slot="trigger">
        <b-button type="is-primary" >
          Нажать для выбора организации ({{ selectedOptions.length }})
        </b-button>
      </template>
...
<!--     
    <b-button class="dropdown" @click="selectOptionsByIds(ids)" aria-role="listitem">
      <span>Выбрать </span>
    </b-button>

    
    <b-button class="dropdown" @click="selectOptionsByIds(ids2)" aria-role="listitem">
      <span>Выбрать</span>
    </b-button> -->
